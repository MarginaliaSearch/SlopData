...
public class EnumColumn {
    ...
    public static StringColumnWriter create(Path path, ColumnDesc columnDesc) throws IOException {
        return new Writer(columnDesc,
                StringColumn.create(path, columnDesc.createSupplementaryColumn(ColumnFunction.DICT, ColumnTypes.TXTSTRING, StorageType.PLAIN)),
                VarintColumn.create(path, columnDesc.createSupplementaryColumn(ColumnFunction.DATA, ColumnTypes.ENUM_LE, columnDesc.storageType()))
        );
    }
    ...
    public static StringColumnWriter create8(Path path, ColumnDesc columnDesc) throws IOException {
        return new Writer8(columnDesc,
                StringColumn.create(path, columnDesc.createSupplementaryColumn(ColumnFunction.DICT, ColumnTypes.TXTSTRING, StorageType.PLAIN)),
                ByteColumn.create(path, columnDesc.createSupplementaryColumn(ColumnFunction.DATA, ColumnTypes.BYTE, columnDesc.storageType()))
        );
    }
